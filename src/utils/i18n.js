    ...
    en: {
      translation: {
        ...
        sidebar: {
          ...
          subCategoryManagement: "Sub Category",
          subToSubCategoryManagement: "Sub-to-Sub Category",
        ...
        dashboard: {
          ...
          newProviderRequest: "New Provider Request",
          viewAll: "View all",
          ...
          sar: "Sar",
          providers: "Provider",
          thursdayRevenue: "Thursday Revenue",
        },
        table: {
          name: "Name",
          email: "Email",
          ...
          sub_to_subCategory: "Sub-To-Sub Category",
        ...
        buttons: {
          ...
          addNewSubToSubCategory: "Add New Sub-To-Sub Category",
        },
        search: {
          byName: "By Name",
          byEmail: "By Email",
        ...
        subCategoryDetail: {
          ...
          cancel: "Cancel",
          upload: "Upload",
          uploadTagline: "Upload The Sub Category Icon",
          categoryName: "Category Name",
          subCategoryName: "Sub Category Name",
          sub_to_subCategoryName: "Sub-To-Sub Category Name",
          description: "Description",
          chooseStatus: "Choose Status",
          active: "Active",
          inActive: "In-Active",
        },
        subToSubCategoryDetail: {
          addTitle: "Add Sub-To-Sub Category",
          editTitle: "Edit Sub-To-Sub Category",
          save: "Save Sub-To-Sub Category",
          update: "Update Sub-To-Sub Category",
          cancel: "Cancel",
          upload: "Upload",
          uploadTagline: "Upload The Sub-To-Sub Category Icon",
          categoryName: "Category Name",
          subCategoryName: "Sub Category Name",
          sub_to_subCategoryName: "Sub-To-Sub Category Name",
          description: "Description",
        ...
        payoutDetail: {
          ...
          fusatyCommission: "Fusaty Commission",
          payoutAmount: "payout Amount",
          status: "Status",
          payoutTimingInfo: "Payout Timing Info",
    ...
    ar: {
      translation: {
        ...
        sidebar: {
          ...
          subCategoryManagement: "الفئات الفرعية",
          subToSubCategoryManagement: "الفئات الفرعية الفرعية",
        ...
        dashboard: {
          ...
          newProviderRequest: "طلب إضافة مزود جديد",
          viewAll: "عرض الكل",
          ordersToday: "الطلبات اليومية",
          ...
          cancel: "إلغاء",
          providerList: "قائمة المزودين",
          providerName: "اسم المزود",
          categoryName: "اسم الفئة",
          actions: "الإجراءات",
          approve: "موافقة",
          reject: "رفض",
          releaseNow: "إصدار الآن",
          viewDetails: "عرض التفاصيل",
          sar: "ريال",
          providers: "المزودين",
          thursdayRevenue: "الإيرادات الخميسية",
        },
        table: {
          name: "الاسم",
          email: "البريد الإلكتروني",
          ...
          sub_to_subCategory: "الفئة الفرعية للفرعية",
        ...
        buttons: {
          ...
          addNewSubToSubCategory: "إضافة فئة فرعية جديدة للفرعية",
        },
        search: {
          byName: "بالاسم",
        ...
        subCategoryDetail: {
          addTitle: "إضافة فئة فرعية",
          editTitle: "تعديل الفئة الفرعية",
          save: "حفظ الفئة الفرعية",
          update: "تحديث الفئة الفرعية",
          cancel: "إلغاء",
          upload: "رفع",
          uploadTagline: "قم برفع أيقونة الفئة الفرعية",
          categoryName: "اسم الفئة",
          subCategoryName: "اسم الفئة الفرعية",
          sub_to_subCategoryName: "اسم الفئة الفرعية للفرعية",
          description: "الوصف",
          chooseStatus: "اختر الحالة",
          active: "نشط",
          inActive: "غير نشط",
        ...
        subToSubCategoryDetail: {
          addTitle: "إضافة فئة فرعية للفرعية",
          editTitle: "تعديل الفئة الفرعية للفرعية",
          save: "حفظ الفئة الفرعية للفرعية",
          update: "تحديث الفئة الفرعية للفرعية",
          cancel: "إلغاء",
          upload: "رفع",
          uploadTagline: "قم برفع أيقونة الفئة الفرعية للفرعية",
          categoryName: "اسم الفئة",
          subCategoryName: "اسم الفئة الفرعية",
          sub_to_subCategoryName: "اسم الفئة الفرعية للفرعية",
          description: "الوصف",
        ...
        payoutDetail: {
          ...
          category: "الفئة",
          orderCompletionDate: "تاريخ إكمال الطلب",
          orderAmount: "مبلغ الطلب",
          fusatyCommission: "عمولة Fusaty",
          payoutAmount: "مبلغ الدفع",
          status: "الحالة",
          payoutTimingInfo: "معلومات توقيت الدفع",
          orderCompletionTime: "وقت إكمال الطلب",
          eligibleForPayout: "مؤهل للدفع",
          action: "إجراء",
          autoRelease: "إصدار تلقائي",
          releaseNow: "إصدار الآن",
          hold: "معلّق",
          save: "حفظ",
        },
